...
#CFLAGS= -Wall -Ofast -std=c99 -DNDEBUG -fopenmp -march=native -Wno-unused-function 
CFLAGS= -Wall -O3 -std=c99 -DNDEBUG -march=native -Wno-unused-function 
#CFLAGS_LIB= -Wall -Ofast -std=c99 -pedantic -DNDEBUG -fopenmp -march=native -Wno-unused-function 
